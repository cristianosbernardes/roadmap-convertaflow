...
export function KanbanCard({ feature }: { feature: Feature }) {
  return (
    ...
    >
      <article
        className="flex items-center gap-3 p-3 transition-all duration-200 ease-out will-change-transform hover:scale-[1.01] hover:shadow-[0_4px_12px_rgba(30,127,212,0.08)] active:scale-[0.995]"
        style={{
